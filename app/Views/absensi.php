            ...
            <div class="custom-block d-flex flex-column" style="background-color:#FAF5F1; border-radius:16px; box-shadow:0 4px 10px rgba(0,0,0,0.1);">
                ...
                <ul class="nav nav-tabs mb-4" id="absensiTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="absensi-tab" data-bs-toggle="tab" data-bs-target="#absensi-table" type="button" role="tab">Tabel Absensi</button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="absensiTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="absensi-table" role="tabpanel">
                        <table id="absensiTable" class="table table-hover datatable" style="background-color: #ffffff; border-radius: 10px; overflow: hidden;">
